    ...
    return ListView(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(gradient: const LinearGradient(colors: [SteelColors.ink, Color(0xFF1E4FB7)]), borderRadius: BorderRadius.circular(24)),
            child: Row(children: [
              const _HeaderIcon(),
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return InkWell(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(color: selected ? SteelColors.primary.withValues(alpha: .10) : Theme.of(context).colorScheme.surfaceContainerHighest.withValues(alpha: .45), border: Border.all(color: selected ? SteelColors.primary : Theme.of(context).dividerColor, width: selected ? 1.5 : 1), borderRadius: BorderRadius.circular(14)),
                        child: Row(children: [Icon(selected ? Icons.check_circle_rounded : Icons.language_rounded, color: selected ? SteelColors.primary : SteelColors.muted, size: 20), const SizedBox(width: 9), Expanded(child: Text(names[index], style: TextStyle(fontWeight: selected ? FontWeight.w800 : FontWeight.w600)))]),
                      ),
                    );
                  },
                );
